...
TEXT ·sm2p256ordMul(SB),NOSPLIT,$0
	...
	MOVD	K0<>(SB), hlp1
	LDP	<>+0x00(SB), (const0, const1)
	LDP	<>+0x10(SB), (const2, const3)
...
TEXT ·sm2p256PointAddAffineAsm(SB),0,$264-96
	MOVD	in1+24(FP), a_ptr
	MOVD	in2+48(FP), b_ptr
	...
	CSEL	EQ, acc2, y2, y2
	CSEL	EQ, acc3, y3, y3
	LDP	p256Gmone<>+0x00(SB), (acc0, acc1)
	LDP	p256Gmone<>+0x10(SB), (acc2, acc3)
	...
	sm2p256MulBy2Inline               // u1 * hˆ2 * 2, inline
...
TEXT ·sm2p256PointDoubleAsm(SB),NOSPLIT,$136-48
	MOVD	res+0(FP), res_ptr
	MOVD	in+24(FP), a_ptr
...
TEXT ·sm2p256PointAddAsm(SB),0,$392-80
